...
const QuizStats = ({ quizStats, quizDetails }) => {
    ...
    return (
        <div className='px-8 py-5 md:px-20 xl:px-40 lg:py-10 flex flex-col xl:mt-0 text-eerieBlack'>
            ...
            <div className="bg-chineseViolet text-ivory w-full md:w-95 h-36 p-2 relative flex items-center justify-center mt-5 rounded-2xl shadow-[0_0_17px_rgba(0,0,0,0.25)]">
                ...
                <div className='flex justify-between flex-col'>
                    ...
                    <p className='flex gap-2 text-lg md:text-xl lg:text-2xl'>
                        <span className='w-16 md:w-22 font-semibold'>Skiped</span>
                        <span>:</span>
