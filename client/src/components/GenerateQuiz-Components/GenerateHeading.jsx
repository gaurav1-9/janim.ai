...
const GenerateHeading = () => {
    return (
        <div className='px-8 py-5 md:px-20 xl:px-40 lg:py-10 flex flex-col text-eerieBlack'>
            <p className='font-semibold text-3xl lg:text-4xl xl:text-5xl w-65 md:w-full'>
            ...
            <div className='text-base lg:text-2xl xl:text-3xl pt-2 lg:pt-3 xl:pt-5 w-60 md:w-full'>
